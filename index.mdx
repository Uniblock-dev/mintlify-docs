...
<Columns cols={3}>
  ...
  <Card
    title='Unified APIs'
    icon='layer-group'
    href='/reference/unified-api/overview-unified-apis'
  >
  ...
  <Card
    ...
    icon='plug'
    href='/reference/direct-api/overview-direct-api'
  >
...
<Columns cols={2}>
  <Card
    ...
    icon='book'
    href='/reference/jsonrpc-docs/1/ethereum-overview'
  >
  ...
  <Card
    ...
    icon='link'
    href='/reference/resources/chains/supported-json-rpc-chains'
  >
...
<Columns cols={3}>
  <Card title='Token API' icon='coins' href='unified-api/api-overview-token'>
  ...
  <Card title='NFT API' icon='images' href='unified-api/api-overview-nft'>
  ...
  <Card
    title='Webhook API'
    icon='bell'
    href='/reference/webhook/webhooks-overview'
  >
...
<Columns cols={3}>
  ...
  <Card
    ...
    icon='chart-simple'
    href='/reference/resources/chains/supported-market-data-chains'
  >
