...
<Expandable title='Default parameters'>
  ...
  <ParamField body='method' type='string' required default='starknet_getClassAt'>
    JSON-RPC method name.
  </ParamField>
</Expandable>

<ParamField body='params' type='object' required placeholder='{"block_id":{"block_hash":"0x041b10c45dc3f39372f7b9409261cac9d880c5d75a5bb077d028db20b1bd76c4"},"contract_address":"0x03b554093fb0a7460913be2d5c011cb5ac4333dfcfe6125851bcd3f926a3b558"}'>
  Parameters for starknet_getNonce: [block_id, contract_address].
  
  Parameters for <code>starknet_getClassAt</code>:
  <ul>
