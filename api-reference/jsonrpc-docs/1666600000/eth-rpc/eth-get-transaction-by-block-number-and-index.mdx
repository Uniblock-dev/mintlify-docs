...
<Expandable title='Default parameters'>
  ...
  <ParamField body='method' type='string' required default='eth_getTransactionByBlockNumberAndIndex'>
    JSON-RPC method name.
  </ParamField>
</Expandable>

<ParamField body='params' type='object' required placeholder='["0x29c","0x0"]'>
  Parameters for eth_getTransactionByBlockNumberAndIndex: [blockNumber, index].
  
  Positional parameters for <code>eth_getTransactionByBlockNumberAndIndex</code>:
  <ul>
