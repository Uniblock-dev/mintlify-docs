...
<Expandable title='Default parameters'>
  ...
  <ParamField body='method' type='string' required default='eth_feeHistory'>
    JSON-RPC method name.
  </ParamField>
</Expandable>

<ParamField body='params' type='object' required placeholder='["0x5","latest",[20,30]]'>
  Parameters: [blockCount, newestBlock, rewardPercentiles]
  
  Positional parameters for <code>eth_feeHistory</code>:
  <ul>
