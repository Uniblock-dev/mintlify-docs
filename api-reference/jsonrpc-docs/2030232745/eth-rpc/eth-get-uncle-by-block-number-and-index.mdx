...
<Expandable title='Default parameters'>
  ...
  <ParamField body='method' type='string' required default='eth_getUncleByBlockNumberAndIndex'>
...
<ParamField body='params' type='object' required placeholder='[0,0]'>
  ...
  Positional parameters for <code>eth_getUncleByBlockNumberAndIndex</code>:
  <ul>
