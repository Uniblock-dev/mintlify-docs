...
<Expandable title='Default parameters'>
  ...
  <ParamField body='method' type='string' required default='trace_block'>
    JSON-RPC method name.
  </ParamField>
</Expandable>

<ParamField body='params' type='object' required placeholder='["0x2ed119"]'>
  Parameters for trace_block method: [defaultBlock]
  
  Positional parameters for <code>trace_block</code>:
  <ul>
