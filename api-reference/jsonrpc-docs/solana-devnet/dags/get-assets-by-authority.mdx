...
### Parameters
  ...
  <ParamField body='method' type='string' required default='getAssetsByAuthority'>
    JSON-RPC method name.
  </ParamField>

<ParamField body='params' type='object' required default={{"authorityAddress":"mdaoxg4DVGptU4WSpzGyVpK3zqsgn7Qzx5XNgWTcEA2","limit":10}} placeholder='{"authorityAddress":"mdaoxg4DVGptU4WSpzGyVpK3zqsgn7Qzx5XNgWTcEA2","limit":10}'>
  Positional parameters for <code>getAssetsByAuthority</code>:
  <ul>
