...
<Expandable title='Default parameters'>
  ...
  <ParamField body='method' type='string' required default='getAssetProof'>
    JSON-RPC method name.
  </ParamField>
</Expandable>

<ParamField body='params' type='object' placeholder='{"id":"Bu1DEKeawy7txbnCEJE4BU3BKLXaNAKCYcHR4XhndGss"}'>
