...
### Parameters
  ...
  <ParamField body='method' type='string' required default='getAsset'>
    JSON-RPC method name.
  </ParamField>

<ParamField body='params' type='object' required default={{"id":"9ARngHhVaCtH5JFieRdSS5Y8cdZk2TMF4tfGSWFB9iSK","options":{"showFungible":true}}} placeholder='{"id":"9ARngHhVaCtH5JFieRdSS5Y8cdZk2TMF4tfGSWFB9iSK","options":{"showFungible":true}}'>
