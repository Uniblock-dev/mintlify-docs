...
<ParamField body='params.subnetID' type='string'>
  Optional ID of the subnet. If omitted, returns validators of the Primary Network.
</ParamField>
<ParamField body='params.nodeIDs' type='string[]'>
  Optional list of NodeIDs to filter the validators returned.
</ParamField>
