...
<Columns cols={3}>
  <Card title='Unified JSON-RPC' icon='terminal'>
  ...
  <Card title='Direct Provider APIs' icon='plug'>
...
<Columns cols={2}>
  ...
  <Card
    ...
    icon='link'
    href='resources/chains/supported-json-rpc-chains'
  >
...
<Columns cols={3}>
  ...
  <Card title='NFT API' icon='images'>
    NFT collections, assets, and related NFT metadata.
  </Card>
  <Card title='Transaction API' icon='arrow-right-arrow-left'>
    Transaction lookups and transaction-related data.
  </Card>
  <Card title='Scan API' icon='magnifying-glass'>
    Chain scanning and explorer-style access patterns.
  </Card>
  <Card title='Webhook API' icon='bell'>
...
<Card
  ...
  icon='plug'
  href='direct-api/overview-direct-api'
  horizontal
>
...
<Columns cols={3}>
  ...
  <Card
    ...
    icon='hashtag'
    href='resources/chains/supported-chains'
  >
  ...
  <Card
    ...
    icon='chart-simple'
    href='resources/chains/supported-market-data-chains'
  >
