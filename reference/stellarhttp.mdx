---
title: "/stellar-http/*path"
description: "Ask AI"
---

get

https\://api.uniblock.dev/uni/v1/stellar-http/\*path
...
<CodeGroup>
  ```bash bash
  curl --location 'https://api.uniblock.dev/uni/v1/stellar-http/accounts/GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN/payments?chainId=stellar&limit=2' \
  --header 'x-api-key: {{API_KEY}}' \
