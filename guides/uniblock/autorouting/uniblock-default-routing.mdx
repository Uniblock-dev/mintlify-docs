...
Note that default routing is not for production. It subjects to rate limits that can be hit easily. [Get your API key for free](doc:uniblock-quickstart-guide) to start building with Uniblock.
...
* [Unified API Reference](ref:unified-api-reference-overview)
* [Uniblock Explorer](https://explorer.uniblock.dev/)

For instance you can use our Unified API Reference to start calling [/token/balance](ref:tokenmetadata) by clicking the big blue `Try it!` button.
...
[Auto Routing](/docs/unified-api-auto-routing)

[Backup](/docs/unified-api-backup)
